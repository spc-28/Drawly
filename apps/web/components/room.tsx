...
export default function Room({ roomId }: { roomId: number }) {
    ...
    if (!ws) {
        return(
            ...
            <div role="status">
                <svg aria-hidden="true" className="inline w-20 h-20 text-transparent animate-spin fill-slate-100" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
